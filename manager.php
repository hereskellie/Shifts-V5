    ...
    <center>
        <table border="0" cellpadding="20px">
            <tr>
                ...
                <td>
                   <div>
      <form action="" id="finalmanagerlogin">
        <header>
          <h2><font color="white">Shifts Manager Login</font></h2>
        </header>
        <div>
          <label class="labelStyle" id="logintitle1" for="loginField1"><font color="white">Login Email:</font></label>
          <div>
            <input id="finalmanagerloginInput" name="loginField1" type="text" value="" tabindex="1" placeholder="enter email address">
          </div>
        </div><!--end of login field-->
        <div>
          <label class="labelStyle" id="logintitle2" for="loginField2"><font color="white">Password:</font></label>
          <div>
            <input id="finalmanagerpwField" name="loginField2" type="password" value="" tabindex="2" placeholder="enter password">
          </div>
        </div><!--end of password-->
        <br />
        <div>
        
          <input id="finalmanagerloginForm" name="registerForm" type="submit" value="Login" class="rosterclicks">
        </div><!--end of submit-->
      </form>
    </div>
